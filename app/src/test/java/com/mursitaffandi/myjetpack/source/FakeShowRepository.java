...
import com.mursitaffandi.myjetpack.data.source.NetworkBoundResource;
...
public class FakeShowRepository implements ShowDataSource {
    ...
    public FakeShowRepository(@NonNull LocalRepository localRepository, @NonNull RemoteRepository remoteRepository, AppExecutors appExecutors) {
        this.localRepository = localRepository;
        this.remoteRepository = remoteRepository;
        this.appExecutors = appExecutors;
    }
    
    public static FakeShowRepository getInstance(LocalRepository localRepository, RemoteRepository remoteData, AppExecutors appExecutors) {
        if (INSTANCE == null) {
            synchronized (ShowRepository.class) {
                if (INSTANCE == null) {
                    INSTANCE = new FakeShowRepository(localRepository, remoteData, appExecutors);
                }
            }
        }
        return INSTANCE;
